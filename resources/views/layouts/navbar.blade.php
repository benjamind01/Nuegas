<div id="navbar" class="w-2/12 bg-white flex flex-col items-center justify-between">
    <div id="buttons" class="flex flex-col items-center">
        ...
        <div id="links" class="mt-12">
            <div class="bg-rectangle flex flex-row justify-center items-center py-2 pl-4 pr-10 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25zM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-2.25z" />
                </svg>
                  <p class="font-PlusJakartaSans font-semibold ml-2">Overview</p>
            </div> 
            <a href="#">
            <div class=" flex flex-row items-center py-2 pl-4 pr-10 rounded-lg mt-4 hover:bg-rectangle transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-text-link">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                  </svg>                  
                  <p class="font-PlusJakartaSans font-semibold ml-2 text-text-link">Tasks</p>
            </div> 
            </a>
            <a href="#">
            <div class=" flex flex-row items-center py-2 pl-4 pr-10 rounded-lg mt-4 hover:bg-rectangle transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-text-link">
                  ...
                  <p class="font-PlusJakartaSans font-semibold ml-2 text-text-link">Teachers</p>
            </div> 
            </a>
            <a href="#">
            <div class=" flex flex-row items-center py-2 pl-4 pr-10 rounded-lg mt-4 hover:bg-rectangle transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-text-link">
                  ...
                  <p class="font-PlusJakartaSans font-semibold ml-2 text-text-link">Messages</p>
            </div> 
            </a>
            <a href="#">
            <div class=" flex flex-row items-center py-2 pl-4 pr-10 rounded-lg mt-4 hover:bg-rectangle transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-text-link">
                  ...
                  <p class="font-PlusJakartaSans font-semibold ml-2 text-text-link">Settings</p>
             </div> 
            </a>
        </div>
