<div id="main" class="w-10/12 flex flex-col items-center mt-8">
    ...
    <div class="flex mt-8 w-11/12 flex-row items-center justify-between">
            <h3 class="font-PlusJakartaSans font-medium text-xl">Teachers</h3>
    ...
    <div id="cards" class="mt-8 w-11/12 flex flex-row">
